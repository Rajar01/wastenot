...
import DonateFormPopup from "@/components/molecules/shared/DonateFormPopup.tsx";
...
export default function CauseDetailsPage() {
  ...
  const [isDonateFormActive, setIsDonateFormActive] = useState(false);
  ...
  const openDonateForm = () => {
    setIsDonateFormActive(!isDonateFormActive);
  };
  ...
  return (
    <>
            ...
            <div className="space-y-8 mt-10">
              ...
              <div className="w-full">
                <iframe
                  ...
                  marginHeight="0"
                  marginWidth="0"
                  src={`https://www.google.com/maps?q=${cause["cause_geocoordinate"] !== undefined && removeAllWhiteSpace(cause["cause_geocoordinate"])}&hl=es;z%3D14&amp&output=embed`}
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <DonateFormPopup
        causeId={cause["id"]}
        active={isDonateFormActive}
        onClose={closeDonateForm}
      />
    </>
  );
}
